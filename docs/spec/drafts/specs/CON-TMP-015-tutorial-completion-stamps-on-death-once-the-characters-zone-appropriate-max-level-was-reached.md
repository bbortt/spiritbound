...
- [STR-TMP-005](../stories/STR-TMP-005-zone-mastery-stops-xp-and-graduates-tutorial-accounts.md) — the story delivering this decision
- [CON-008](CON-008-first-reaching-level-ten-stamps-tutorial-completed-exactly-once.md) — superseded by this spec; flag for clew-promote to mark deprecated and confirm no other anchor still depends on the literal `10`
