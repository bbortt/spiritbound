...
- [SW-TMP-012](../specs/SW-TMP-012-xp-grant-returns-zero-at-or-above-the-zones-max-level.md)
- [SW-TMP-013](../specs/SW-TMP-013-zone-mastered-displays-only-when-the-zero-is-caused-by-the-zone-cap.md)
- [SW-TMP-014](../specs/SW-TMP-014-tutorial-completion-keys-off-the-zones-max-level-and-shows-a-one-time-message.md)
- [SW-TMP-015](../specs/SW-TMP-015-startlife-computes-the-start-zone-from-tutorial-completion-not-caller-input.md)
- [CON-TMP-015](../specs/CON-TMP-015-tutorial-completion-stamps-on-death-once-the-characters-zone-appropriate-max-level-was-reached.md)
...
- [CON-008](../specs/CON-008-first-reaching-level-ten-stamps-tutorial-completed-exactly-once.md) — superseded by `CON-TMP-015`; the hardcoded `10` this story replaces with `zone.maxLevel`
