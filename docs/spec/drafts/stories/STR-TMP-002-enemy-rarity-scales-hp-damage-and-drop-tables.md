...
If a future story
  ...
  implicitly.
- An `EnemyDefinition` content table — see `ARCH-TMP-001`'s rationale for
...
- [SYS-TMP-001](../specs/SYS-TMP-001-enemy-difficulty-scales-with-rarity-as-well-as-level.md)
- [ARCH-TMP-001](../specs/ARCH-TMP-001-enemy-rarity-and-boss-flag-are-columns-on-the-flat-enemy-row.md)
- [SW-TMP-001](../specs/SW-TMP-001-compute-enemy-stats-scales-hp-and-damage-by-level-and-rarity-multiplier.md)
- [SW-TMP-002](../specs/SW-TMP-002-a-non-common-mob-shifts-its-drop-weights-toward-higher-rarity-tiers.md)
- [CON-TMP-008](../specs/CON-TMP-008-rarity-multipliers-cover-every-rarity-at-or-above-one-increasing-by-tier.md)
