...
- [SYS-013](../specs/SYS-013-population-allocation-decides-target-and-adjustment-counts-independent-of-execution.md)
- [SW-041](../specs/SW-041-compute-target-population-clamps-base-plus-per-player-scaling.md)
- [SW-042](../specs/SW-042-allocate-bands-guarantees-each-occupied-bands-floor-before-proportional-split.md)
- [SW-043](../specs/SW-043-allocate-bands-caps-a-band-at-its-share-and-redistributes-the-overflow.md)
- [SW-044](../specs/SW-044-allocate-bands-corrects-rounding-drift-onto-the-largest-band.md)
- [SW-045](../specs/SW-045-allocate-bands-rests-evenly-across-bands-when-none-are-occupied.md)
- [SW-046](../specs/SW-046-plan-adjustments-ignores-in-deadband-deltas-and-never-goes-negative.md)
- [SW-047](../specs/SW-047-plan-adjustments-caps-total-spawns-and-despawns-and-favours-spawning.md)
- [SW-048](../specs/SW-048-passive-respawn-retires-an-over-target-enemy-or-re-rolls-it-into-the-neediest-band.md)
