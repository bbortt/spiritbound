...
- [CON-028](CON-028-a-despawn-target-must-be-idle-undamaged-boss-free-and-far-from-every-player.md) — the ordinary despawn gate this unconditional rule deliberately contrasts with
